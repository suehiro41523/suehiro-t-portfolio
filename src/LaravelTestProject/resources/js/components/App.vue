...
import TopWorks from "./TopWorks.vue";
...
<template>
    ...
    >
        <div class="w-fit text-gray-100 mx-auto py-4 flex flex-col gap-4">
            <div>
            ...
            >
                これまでの経験をさらに詳しくご覧いただくお時間があればぜひ<br />
                私のブログもご覧になってみてください。
            </div>
            <div class="ml-auto">
    ...
    <section class="container mx-auto">
        ...
        <div>
            ...
            <div class="ml-auto w-fit">
                <CtaButton text="ブログ一覧をみる" link="#"></CtaButton>
            </div>
        </div>
    </section>
    <Footer></Footer>
